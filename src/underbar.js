(function() {
  ...
  _.every = function(collection, iterator) {
    ...
    // }, true);
    return _.reduce(collection, function(accum, index) {
      if (iterator) {
        if (accum) {
          return iterator(index) ? true : false; 
        } else {
          return false;
        } 
      } else {
  ...
  _.memoize = function(func) {
    ...
    return function() {
      ...
      return result[args] = func.apply(this, arguments);
  ...
  _.delay = function(func, wait) {
    ...
    setTimeout(function() { func.apply(this, newArguments); }, wait);
  };
